...
const BLOG = {
  ...
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || ture, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '最后的乌托邦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '有灵魂的柯基', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://page1.kyovpn.ip-ddns.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '灵魂柯基辣评世界', // 网站关键词 英文逗号隔开
  ...
  _FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '最后得乌托邦', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '自由的辣评大千世界', // 站点描述，被notion中的页面描述覆盖
